...
// Type the route and navigation props using RootStackParamList
export default function GameOverScreen({ route, navigation }: NativeStackScreenProps<RootStackParamList, 'GameOverScreen'>) {
  const { score, result } = route.params;
...
const styles = StyleSheet.create({
  outerContainer: {
    flex: 1,
    backgroundColor: 'rgba(50, 100, 50, 0.7)',
    padding: 20,
  },
  scrollContainer: {
    flexGrow: 1,
